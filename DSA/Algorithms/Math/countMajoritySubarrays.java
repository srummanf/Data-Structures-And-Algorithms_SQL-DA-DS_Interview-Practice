...
public class countMajoritySubarrays {
    public int countMajoritySubarray(int[] nums, int target) {
        int n = nums.length;
        int ans = 0;
    ...
    public static void main(String[] args) {
        countMajoritySubarrays solution = new countMajoritySubarrays();
        int[] nums = {1, 2, 1, 1, 3};
        int target = 1;
        int result = solution.countMajoritySubarray(nums, target);
