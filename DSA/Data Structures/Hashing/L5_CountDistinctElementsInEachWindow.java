...
Sample Input: arr = [1, 2, 1, 3, 4, 2, 3], k = 4
Sample Output: 2 3 3
*/

import java.util.HashMap;

public class L5_CountDistinctElementsInEachWindow {

  void printDistinctElements(int arr[], int n, int k) {
    HashMap<Integer, Integer> m = new HashMap<>();
    // Add the first k elements to the HashMap
    for (int i = 0; i < k; i++) {
  ...
  public static void main(String[] args) {
    L5_CountDistinctElementsInEachWindow c = new L5_CountDistinctElementsInEachWindow();
